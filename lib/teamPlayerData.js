...
const getTeamDetails = async (req, teamID, gameweek, gwLive, fixtureData, bpsData, bootstrapData, dataMap) => {
    try {
        ...
        // BUG: Players remaining to include +1 for captain
        ...
        const activePlayers = activeStartingPlayers + activeBenchPlayers;
        const remainPlayer = remainStartingPlayers + remainBenchPlayers;
