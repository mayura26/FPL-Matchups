...
async function getPlayerInfo(req, player, dataMap, gameData) {
    ...
    currentGames.forEach(game => {
        ...
        currentGame.score += game.total_points;
        currentGame.minutes += game.minutes;
        currentGame.xGI += game.expected_goal_involvements;
        currentGame.xGC += game.expected_goals_conceded;
        currentGame.xG += game.expected_goals;
        currentGame.xA += game.expected_assists;
        currentGame.ICT += game.ict_index;
    })
