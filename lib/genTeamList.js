...
const getAndStoreTeamData = async () => {
    const maxTeamID = 2000;
    const firstTeamID = 1001;
    const writeInterval = 100; // Set the interval for writing to disk
    const logInterval = 200; // Set the interval for logging
